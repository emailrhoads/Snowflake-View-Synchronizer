/* drop objects */
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_RCACTUALS_V2;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_LASTESTRECORD;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_LASTESTEMPRECORDS;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_ONE_ROW_PER_EMPLOYEE;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_PROJECTMILESTONEINFO;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_RELEASEITEMINFO;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_EFFORTLISTING;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_TIMESHEETENTRIES;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_REDLINEACTUALS_V2;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_ACTUALS_V2;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_ASOFDATE;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_FORECAST_V2;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_FORECAST_AND_ACTUAL_COMBINED_V2;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_EMPLOYEE_HIERARCHY;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_FORECAST_AND_ACTUAL_COMBINED_INFO_V2A;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_WEEKLYTOTALSBYEMP;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_FORECAST_AND_ACTUAL_COMBINED_INFO_V2B;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_FORECASTANDACTUALCOMBINEDINFO;
DROP TABLE IF EXISTS RESOURCE_CAPACITY.PNMAC.MVW_FORECASTANDACTUALCOMBINEDINFO;
DROP VIEW IF EXISTS RESOURCE_CAPACITY.PNMAC.VW_MISSINGTIMESHEETENTRIES;
DROP TABLE IF EXISTS RESOURCE_CAPACITY.PNMAC.MVW_MISSINGTIMESHEETENTRIES;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_MONTHTABLE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_MONTHTABLE;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_MONTHLY_EMPLOYEES;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_MONTHLY_EMPLOYEES_WITH_BUDGET;
DROP VIEW IF EXISTS DW_ORG.PNMAC.VW_MOSTRECENTEMPLOYEERECORDBYLOGIN;
DROP TABLE IF EXISTS DW_ORG.PNMAC.MVW_MONTHLY_EMPLOYEES_WITH_BUDGET;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_CLARIFICATIONCOUNT;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_EMPLOYEE_LISTING;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_RECENTJOURNALDETAILS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_HOLDANDCLARIFICATIONCHANGE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_HOLDCLARIFYLIFECYCLE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_HOLDCOUNT;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_ISSUESTATUSLATEST;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_JOURNALANDDETAILS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_LASTSTATUSCHANGEJOURNALENTRY;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_LASTUPDATE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_NEXTSTATUSCHANGE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_PROJECTMETADATA;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_PROJECT_ROLE_ASSIGNMENTS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_READONLYACCESSREVIEW;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEARTIFACTS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEARTIFACTSPARENTSONLY;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEISSUESANDPROJECTS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINESDLC;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINESDLCALL;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_STATUSLIFECYCLE;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_STATUSLIFECYCLESUMMARY;
DROP TABLE IF EXISTS REDLINE.PNMAC.MVW_STATUSLIFECYCLESUMMARY;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEWORKSTUDY;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEWORKSTUDYMONTHLY;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_REDLINEWORKSTUDYWITHHOURS;
DROP VIEW IF EXISTS REDLINE.PNMAC.VW_USERPROJECTACCESSREVIEW;
...
DROP TABLE IF EXISTS RESOURCE_CAPACITY.PNMAC.MVW_FORECASTANDACTUALCOMBINEDINFO;
CREATE TABLE RESOURCE_CAPACITY.PNMAC.MVW_FORECASTANDACTUALCOMBINEDINFO AS SELECT * FROM RESOURCE_CAPACITY.PNMAC.VW_FORECASTANDACTUALCOMBINEDINFO;
...
DROP TABLE IF EXISTS RESOURCE_CAPACITY.PNMAC.MVW_MISSINGTIMESHEETENTRIES;
CREATE TABLE RESOURCE_CAPACITY.PNMAC.MVW_MISSINGTIMESHEETENTRIES AS SELECT * FROM RESOURCE_CAPACITY.PNMAC.VW_MISSINGTIMESHEETENTRIES;
...
CREATE OR REPLACE VIEW "REDLINE"."PNMAC"."VW_REDLINEARTIFACTS" AS
SELECT 
